export const settingsStyles = {
  ...
  workspaceInner: [
    "mx-auto flex w-full max-w-2xl flex-col gap-8 overflow-x-hidden p-5 sm:p-6 lg:p-8",
  ].join(" "),
  workspaceInnerWide: [
    "mx-auto flex w-full max-w-3xl flex-col overflow-x-hidden p-5 sm:p-6 lg:p-8",
  ].join(" "),
  intro: "max-w-xl",
