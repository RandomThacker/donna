export const commandsStyles = {
  ...
  inner: [
    "relative mx-auto flex w-full max-w-5xl flex-col gap-8",
  ...
  guideHead: "relative flex items-start gap-3 px-4 pt-4 sm:px-5 sm:pt-5",
  iconWrap: [
  ...
  exampleRow: [
    ...
    "bg-donna-bg/50 px-2.5 py-2",
    "transition-[border-color,background-color] duration-150",
    "hover:border-donna-accent/25 hover:bg-donna-elevated/60",
  ].join(" "),
  phrase: [
    "min-w-0 flex-1 font-mono text-[0.72rem] leading-snug text-donna-text",
    "sm:text-[0.78rem]",
  ].join(" "),
  actions: "flex shrink-0 items-center gap-0.5",
  iconBtn: [
    "grid h-7 w-7 place-items-center rounded-full text-donna-muted",
