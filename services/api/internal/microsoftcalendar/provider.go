...
// Ensure Provider implements calendarprovider.Provider.
var _ calendarprovider.Provider = (*Provider)(nil)

// Provider adapts the Microsoft Graph Calendar HTTP client to calendarprovider.Provider.
type Provider struct {
	client *Client
}

// NewProvider wraps a Microsoft Graph Calendar API client.
...
func (p *Provider) Name() string { return constant.AuthProviderMicrosoft }
